...
shouldBeTrue = is31Flavors(originalFlavors);
console.log(shouldBeTrue, "--> Should be true");
shouldBeFalse = is31Flavors(testArray);
console.log(shouldBeFalse, "--> Should be false");
...
function addFlavor(arr, flavor) {
  //   arr[0] = flavor;
  arr.unshift(flavor);
  console.log("Add item to begining of array: \n", arr);
}
...
function removeLastFlavor(arr) {
  let popArr = arr.pop();
  console.log("New array, remove last flavor: \n", arr);
  return popArr;
}

let popped = removeLastFlavor(originalFlavors);
...
let indexedItem = getFlavorByIndex(originalFlavors, 5);
console.log("Get item at specific index: \n", indexedItem);
